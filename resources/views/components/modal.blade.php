...
<div x-data="{
    ...
    <div x-show="show" class="fixed inset-0 transition-all transform" x-on:click="show = false"
        ...
        <div class="absolute inset-0 opacity-75 bg-neutral-900"></div>
    </div>

    <div x-show="show"
        class="mb-6 dark:bg-neutral-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
