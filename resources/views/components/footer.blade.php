<div class="mx-auto mt-auto">
    <footer class="items-center p-4 shadow md:flex md:justify-between md:p-6 bg-neutral-950">
        <span class="flex items-center gap-1 text-sm text-gray-400 sm:text-center">© {{ now()->year }}<a
                href="https://movierating.000.pe/" class="hover:underline hover:text-lime-300" target="_blank"> Movie
                Rating™ </a>. All Rights
            Reserved.
        </span>
        <div class="flex items-center gap-2 text-sm text-gray-400">
            Powered by : <a class="underline hover:text-lime-300" href="https://www.omdbapi.com/">OMDB</a><a
                ...
                <svg class="w-6 h-6" fill="#3ab8c1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
