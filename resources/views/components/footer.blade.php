<div class="mx-auto mt-auto">
    <footer class="items-center p-4 shadow md:flex md:justify-between md:p-6 bg-neutral-950">
        <span class="flex items-center text-sm text-gray-400 sm:text-center">© {{ now()->year }} <a
                href="https://movierating.000.pe/" class="hover:underline" target="_blank"> Movie Rating™ </a>. All Rights
            Reserved.
            <div class="flex items-center gap-2 ml-4">
                Powered by : <a class="underline hover:text-lime-300" href="https://www.omdbapi.com/">OMDB</a><a
                    href="https://www.themoviedb.org/">
                    <svg class="w-10 h-10" fill="#3ab8c1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul class="flex flex-wrap items-center mt-3 sm:mt-0">
            <li>
                <a href="#" class="mr-4 text-sm text-gray-400 hover:underline md:mr-6">About</a>
            </li>
            <li>
                <a href="#" class="mr-4 text-sm text-gray-400 hover:underline md:mr-6">Privacy
                    Policy</a>
            </li>
            <li>
                <a href="#" class="mr-4 text-sm text-gray-400 hover:underline md:mr-6">Licensing</a>
            </li>
            <li>
                <a href="#" class="text-sm text-gray-400 hover:underline">Contact</a>
            </li>
        </ul>
    </footer>
